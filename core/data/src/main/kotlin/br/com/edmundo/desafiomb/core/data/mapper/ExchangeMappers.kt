...
fun ExchangeMapItemDto.toIndexEntity(
    rank: Int,
    syncedAt: Long,
): ExchangeIndexEntity =
    ExchangeIndexEntity(
...
fun ExchangeInfoDto.toExchangeEntity(now: Long): ExchangeEntity =
    ExchangeEntity(
        id = id,
        name = name,
        slug = slug,
...
fun ExchangeInfoDto.toDetailEntity(now: Long): ExchangeDetailEntity =
...
fun toExchangeDetail(
    base: ExchangeEntity,
    detail: ExchangeDetailEntity?,
): ExchangeDetail =
    ExchangeDetail(
        id = base.id,
        name = base.name,
...
fun ExchangeAssetEntity.toDomain(): ExchangeAsset =
    ExchangeAsset(
        walletAddress = walletAddress,
