...
class CmcExchangeApiTest {
    ...
    @Test
    fun `dado envelope valido, quando getExchangeMap, entao desserializa status e data`() = runTest {
    ...
    @Test
    fun `dado campo desconhecido no JSON, quando getExchangeInfo, entao desserializa sem lancar excecao`() = runTest {
    ...
    @Test
    fun `dado data nulo, quando getExchangeMap, entao data e null e o status carrega o error_code`() = runTest {
    ...
    @Test
    fun `dado 200 com error_code diferente de zero, quando getExchangeAssets, entao o status reflete o erro sem lancar excecao de transporte`() = runTest {
        server.enqueue(MockResponse().setBody(JsonFixtures.invalidApiKeyResponse).setResponseCode(200))
    ...
    @Test
    fun `dado resposta de assets valida, quando getExchangeAssets, entao desserializa os campos aninhados`() = runTest {
