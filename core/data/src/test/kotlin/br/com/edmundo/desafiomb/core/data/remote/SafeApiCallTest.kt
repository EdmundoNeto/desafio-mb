...
class SafeApiCallTest {
    @Test
    fun `dado resposta com sucesso, quando safeApiCall, entao transforma o data e retorna DomainResult de sucesso`() =
        runTest {
    ...
    @Test
    fun `dado status com error_code diferente de zero, quando safeApiCall, entao retorna failure mapeado do CmcStatus`() =
        runTest {
    ...
    @Test
    fun `dado data nulo com status ok, quando safeApiCall, entao retorna failure Serialization`() =
        runTest {
    ...
    @Test
    fun `dado excecao de rede, quando safeApiCall, entao retorna failure mapeado`() =
        runTest {
            val result =
    ...
    @Test
    fun `dado CancellationException, quando safeApiCall, entao relanca sem converter em failure`() =
        runTest {
            var thrown = false
            try {
                safeApiCall<String, String>(
